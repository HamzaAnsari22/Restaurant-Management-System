    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Products] ([ProductName], [ProductPrice], [ProductImage]) VALUES (@P" +
                "roductName, @ProductPrice, @ProductImage);\nSELECT ProductId, ProductName, Produc" +
                "tPrice, ProductImage FROM Products WHERE (ProductId = SCOPE_IDENTITY())";
...
SELECT ProductId, ProductName, ProductPrice, ProductImage FROM Products WHERE (ProductId = @ProductId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PizzaPoint.Properties.Settings.Default.PizzaPointConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        Products.*\nFROM            Products";
        ...
        public virtual int Fill1(Products.ProductsDataTable dataTable) {
        ...
        public virtual Products.ProductsDataTable GetData1() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            Products.ProductsDataTable dataTable = new Products.ProductsDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
